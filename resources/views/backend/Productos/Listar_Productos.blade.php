<x-layout_admin>
    <div class="container mt-4">
        <div class="row mb-4">
            <div class="col-md-6">
                <h2 class="txt-color">Gestión de Productos</h2>
            </div>
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-dark">
                <h5 class="text-center txt-color mb-0">Lista de Productos</h5>
            </div>
            <div class="card-body">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">
                                        No hay productos registrados. <a href="{{ route('productos.create') }}">Crear uno</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
