<x-layout title="Inicio">
    ...
    <div class="banner-container">
        <img src="{{asset('img/banner(1).png')}}" alt="banner inicio" class="img-fluid">
    </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Juan Perez</h5>
                        <p>Excelente producto, muy satisfecho con la compra. Los tiempos de entrega fueron rápidos, recomendado.</p>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Maria Garcia</h5>
                        <p>Producto de alta calidad, es la segunda vez que compro en el sitio y no tuve inconvenientes.</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="{{asset('img/play1.jpg')}}" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p>Excelente servicio al cliente y producto de calidad, volveria a comprar sin dudas</p>
                    </div>
                </div>
            </div>
